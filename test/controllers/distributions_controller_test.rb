...
class DistributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distribution" do
    assert_difference('Distribution.count') do
      post distributions_url, params: { distribution: { actor_id: @distribution.actor_id, film_id: @distribution.film_id } }
    end
  ...
  test "should update distribution" do
    patch distribution_url(@distribution), params: { distribution: { actor_id: @distribution.actor_id, film_id: @distribution.film_id } }
