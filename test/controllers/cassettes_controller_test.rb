...
class CassettesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cassette" do
    assert_difference('Cassette.count') do
      post cassettes_url, params: { cassette: { film_id: @cassette.film_id, format: @cassette.format } }
    end
  ...
  test "should update cassette" do
    patch cassette_url(@cassette), params: { cassette: { film_id: @cassette.film_id, format: @cassette.format } }
