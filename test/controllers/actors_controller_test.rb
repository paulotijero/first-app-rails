...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birthdate: @actor.birthdate, name: @actor.name, real_name: @actor.real_name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birthdate: @actor.birthdate, name: @actor.name, real_name: @actor.real_name } }
